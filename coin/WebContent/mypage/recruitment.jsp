...
<td class="backs">
<input type="text" name = "id">&nbsp;<button>중복체크</button>
</td>
</tr>
...
<td class="backs">
<input type="password2" >&nbsp;<button>비밀번호 확인</button>
</td>
</tr>
...
<td class="backs"><input type="text" name = "ph1">-<input type="text" name = "ph2">-<input type="text" name = "ph3"></td>
</tr>
...
<input type="text" id="sample6_address" placeholder="주소" class="gi" name = "addr2">
...
<td><input type="text" class="gi" name = "bank2"></td>
</tr>

<tr>
<th align="center" class="backs">계좌비밀번호</th>
<td class="backs"><input type="password" name="bpw"></td>
</tr>

</table>


<button onclick="member(my)">가입하기</button>
<button>취소</button>
</center>
</form>